# GADD — Superseded GitHub-Ledger Design

**Date:** 2026-05-11
**Status:** Superseded
**Superseded by:** `docs/superpowers/specs/2026-05-12-local-ledger-mvp-design.md`

This document previously described a GitHub-ledger-first MVP. That model is no longer the GADD MVP contract.
...
- `CONTEXT.md` for canonical GADD terminology.
...
- `skills/gadd-*/SKILL.md` for command behavior.
