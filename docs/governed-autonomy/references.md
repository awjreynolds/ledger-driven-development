...
Adjacent standards, principles, research, and market writing that informed the Governed Autonomy documentation.

"Governed Autonomy" is not a term claimed here. The phrase and related ideas already appear in AI-governance discussions, and the underlying ingredients exist across business process management, Responsible AI, risk management, auditability, operating model design, and human oversight. The emphasis specific to this repository is the business process as the unit of design under AI autonomy pressure.
