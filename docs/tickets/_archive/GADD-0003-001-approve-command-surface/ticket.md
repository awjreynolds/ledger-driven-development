...
- `/gadd:approve <ticket-id>` is listed wherever the package lists supported GADD commands.
...
- Ledger: `docs/tickets/_archive/GADD-0003-001-approve-command-surface/ledger.yml`
