...
- Child ticket: `docs/tickets/_archive/GADD-0003-002-next-and-approval-routing/ticket.md`
...
- Added PRD and SDD approval gate detection that routes to `/gadd:approve <ticket-id>`.
