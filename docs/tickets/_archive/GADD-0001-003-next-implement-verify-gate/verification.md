...
- Child ticket: `docs/tickets/_archive/GADD-0001-003-next-implement-verify-gate/ticket.md`
...
- Updated `/gadd:next` to prioritize implemented-but-unverified child work with `/gadd:verify <child-ticket-id>`.
...
- `/gadd:next` routes completed but unverified child work to `/gadd:verify <child-ticket-id>`.
