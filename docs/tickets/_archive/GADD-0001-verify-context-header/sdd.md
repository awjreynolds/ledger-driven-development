...
- `/gadd:next`
  ...
  - Reports `/gadd:verify <child-ticket-id>` when implementation is complete but closure is not verified.
- `/gadd:implement`
...
execution_context:
  ...
  approved_artifacts:
    ...
    plan: null
  boundaries:
    product: docs/tickets/_archive/GADD-0001-verify-context-header/prd.md
    design: null
    plan: null
...
artifacts:
  verification:
    path: docs/tickets/GADD-0001/children/GADD-0001-001/verification.md
