...
The implementation evidence references research workflow, readiness label, full read-only visibility, and sensitivity-handling contract changes. Closure is blocked until the merge evidence is reconciled into the repo-local ledger.
