...
The implementation evidence references research artifact, setup template, and optional ledger research-state changes. Closure is blocked until the merge evidence is reconciled into the repo-local ledger.
