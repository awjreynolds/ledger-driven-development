...
- Child ticket: `docs/tickets/1-add-research-and-phase-gates/children/7-downstream-phase-gates-and-github-hierarchy-safeguards/ticket.md`
...
The implementation evidence references downstream phase gates, GitHub hierarchy safeguards, PR-state checks for `/ldd:next` and `/ldd:verify`, and decomposition review-load guardrails. Closure is blocked until the merge evidence is reconciled into the repo-local ledger.
