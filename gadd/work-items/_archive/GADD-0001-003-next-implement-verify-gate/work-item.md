...
- `/gadd:next` prioritizes child work with completed implementation evidence and unverified closure by reporting `/gadd:verify <child-work-item-id>`.
...
- Ledger: `gadd/work-items/_archive/GADD-0001-003-next-implement-verify-gate/ledger.yml`
