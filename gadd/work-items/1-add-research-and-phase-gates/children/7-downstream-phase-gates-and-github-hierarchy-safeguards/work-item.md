...
Add input gates to downstream GADD commands and enforce the GitHub hierarchy: PRD issue -> SDD issue -> native implementation sub-issues.
...
- Ledger: `gadd/work-items/1-add-research-and-phase-gates/children/7-downstream-phase-gates-and-github-hierarchy-safeguards/ledger.yml`
