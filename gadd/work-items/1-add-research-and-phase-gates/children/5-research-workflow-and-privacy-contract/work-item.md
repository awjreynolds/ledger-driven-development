...
Define the `/gadd:research` workflow: standard PM input prompts, full read-only code/docs/local context visibility, sanitized research output, and readiness labels.
...
- Ledger: `gadd/work-items/1-add-research-and-phase-gates/children/5-research-workflow-and-privacy-contract/ledger.yml`
